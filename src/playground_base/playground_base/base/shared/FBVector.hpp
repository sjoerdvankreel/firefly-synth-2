...
typedef xsimd::batch<int, xsimd::sse2> FBIntVector;
...
typedef xsimd::batch<int, xsimd::neon64> FBIntVector;
...
inline int constexpr FBVectorIntCount = sizeof(FBIntVector) / sizeof(int);
