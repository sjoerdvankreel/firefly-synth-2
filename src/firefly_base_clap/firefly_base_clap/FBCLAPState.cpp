...
FBCLAPPlugin::stateSave(const clap_ostream* stream) noexcept
{
  ...
  return FBWithLogException([this, stream]()
  {
    ...
    std::string json = _topo->SaveEditAndGUIStateToString(*_editState, this, *_guiState, false);
...
FBCLAPPlugin::stateLoad(const clap_istream* stream) noexcept
{
  ...
  return FBWithLogException([this, stream]()
  {
    ...
    _topo->LoadEditAndGUIStateFromStringWithDryRun(json, *_editState, this, *_guiState, false);
    OnPatchNameChanged();
