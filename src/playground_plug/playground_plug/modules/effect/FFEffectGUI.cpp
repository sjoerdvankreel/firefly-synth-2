...
MakeSectionBlock(FBPlugGUI* plugGUI, int moduleSlot, int block)
{
  ...
  grid->Add(0, 3, plugGUI->StoreComponent<FBParamSlider>(plugGUI, combFreqPlus, Slider::SliderStyle::LinearHorizontal));
  ...
  grid->Add(1, 3, plugGUI->StoreComponent<FBParamSlider>(plugGUI, combFreqMin, Slider::SliderStyle::LinearHorizontal));
  ...
  grid->Add(0, 3, plugGUI->StoreComponent<FBParamSlider>(plugGUI, stVarFreq, Slider::SliderStyle::LinearHorizontal));
  ...
  grid->Add(1, 3, plugGUI->StoreComponent<FBParamSlider>(plugGUI, stVarRes, Slider::SliderStyle::LinearHorizontal));
  ...
  grid->Add(0, 4, plugGUI->StoreComponent<FBParamLabel>(plugGUI, distGain));
  grid->Add(0, 5, plugGUI->StoreComponent<FBParamSlider>(plugGUI, distGain, Slider::SliderStyle::RotaryVerticalDrag));
  auto distMix = topo->audio.ParamAtTopo({ (int)FFModuleType::Effect, moduleSlot, (int)FFEffectParam::DistMix, block });
  grid->Add(1, 4, plugGUI->StoreComponent<FBParamLabel>(plugGUI, distMix));
  grid->Add(1, 5, plugGUI->StoreComponent<FBParamSlider>(plugGUI, distMix, Slider::SliderStyle::RotaryVerticalDrag));
  auto distClipKind = topo->audio.ParamAtTopo({ (int)FFModuleType::Effect, moduleSlot, (int)FFEffectParam::DistClipKind, block });
  grid->Add(0, 2, plugGUI->StoreComponent<FBParamLabel>(plugGUI, distClipKind));
  grid->Add(0, 3, plugGUI->StoreComponent<FBParamComboBox>(plugGUI, distClipKind));
  auto distClipExp = topo->audio.ParamAtTopo({ (int)FFModuleType::Effect, moduleSlot, (int)FFEffectParam::DistClipExp, block });
  grid->Add(1, 2, plugGUI->StoreComponent<FBParamLabel>(plugGUI, distClipExp));
  grid->Add(1, 3, plugGUI->StoreComponent<FBParamSlider>(plugGUI, distClipExp, Slider::SliderStyle::LinearHorizontal));
  auto distSkewKind = topo->audio.ParamAtTopo({ (int)FFModuleType::Effect, moduleSlot, (int)FFEffectParam::DistSkewKind, block });
  grid->Add(0, 2, plugGUI->StoreComponent<FBParamLabel>(plugGUI, distSkewKind));
  grid->Add(0, 3, plugGUI->StoreComponent<FBParamComboBox>(plugGUI, distSkewKind));
  auto distSkewAmt = topo->audio.ParamAtTopo({ (int)FFModuleType::Effect, moduleSlot, (int)FFEffectParam::DistSkewAmt, block });
  grid->Add(1, 2, plugGUI->StoreComponent<FBParamLabel>(plugGUI, distSkewAmt));
  grid->Add(1, 3, plugGUI->StoreComponent<FBParamSlider>(plugGUI, distSkewAmt, Slider::SliderStyle::LinearHorizontal));
  auto distShapeKind1 = topo->audio.ParamAtTopo({ (int)FFModuleType::Effect, moduleSlot, (int)FFEffectParam::DistShapeKind1, block });
  grid->Add(0, 2, plugGUI->StoreComponent<FBParamLabel>(plugGUI, distShapeKind1));
  grid->Add(0, 3, plugGUI->StoreComponent<FBParamComboBox>(plugGUI, distShapeKind1));
  auto distShapeKind2 = topo->audio.ParamAtTopo({ (int)FFModuleType::Effect, moduleSlot, (int)FFEffectParam::DistShapeKind2, block });
  grid->Add(1, 2, plugGUI->StoreComponent<FBParamLabel>(plugGUI, distShapeKind2));
  grid->Add(1, 3, plugGUI->StoreComponent<FBParamComboBox>(plugGUI, distShapeKind2));
