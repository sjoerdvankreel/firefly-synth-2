...
{
  auto grid = plugGUI->StoreComponent<FBGridComponent>(1, std::vector<int> { 0, 0, 0, 1, 0, 1 } );
  ...
  grid->Add(0, 4, plugGUI->StoreComponent<FBParamLabel>(plugGUI, smooth));
  grid->Add(0, 5, plugGUI->StoreComponent<FBParamSlider>(plugGUI, smooth, Slider::SliderStyle::LinearHorizontal));
