...
MakeSectionHorizontal(FBPlugGUI* plugGUI, int moduleSlot)
{
  ...
  grid->Add(0, 3, plugGUI->StoreComponent<FBParamSlider>(plugGUI, attackTime, Slider::SliderStyle::LinearHorizontal));
  ...
  grid->Add(0, 5, plugGUI->StoreComponent<FBParamSlider>(plugGUI, holdTime, Slider::SliderStyle::LinearHorizontal));
  ...
  grid->Add(1, 1, plugGUI->StoreComponent<FBParamSlider>(plugGUI, decayTime, Slider::SliderStyle::LinearHorizontal));
  ...
  grid->Add(1, 3, plugGUI->StoreComponent<FBParamSlider>(plugGUI, releaseTime, Slider::SliderStyle::LinearHorizontal));
