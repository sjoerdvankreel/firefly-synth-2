...
FFMakeEnvTopo()
{
  ...
  mode.name = "Mode";
  mode.slotCount = 1;
  mode.id = "{1FF0F02E-E3D6-4DCB-8968-07CAC3DDC179}";
  ...
  stageSlope.dependencies.enabled.audio.When({ (int)FFEnvParam::On, (int)FFEnvParam::Mode }, [](auto const& vs) { return vs[0] != 0 && vs[1] == (int)FFEnvMode::Exp; });
