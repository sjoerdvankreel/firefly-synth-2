...
FFMakeEnvTopo()
{
  ...
  delayTime.Log2().min = 0.0f;
  delayTime.Log2().max = 10.0f;
  ...
  attackTime.Log2().min = 0.0f;
  attackTime.Log2().max = 10.0f;
  ...
  holdTime.Log2().min = 0.0f;
  holdTime.Log2().max = 10.0f;
  ...
  decayTime.Log2().min = 0.0f;
  decayTime.Log2().max = 10.0f;
  ...
  releaseTime.Log2().min = 0.0f;
  releaseTime.Log2().max = 10.0f;
  ...
  smoothTime.Log2().min = 0.0f;
  smoothTime.Log2().max = 10.0f;
