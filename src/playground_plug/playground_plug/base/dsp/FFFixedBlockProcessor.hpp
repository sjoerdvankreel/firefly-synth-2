...
public:
  ...
  void Process(FFHostInputBlock const& input, FFRawStereoBlock& output, Processor& processor);
};

template <class Processor>
void 
FFFixedBlockProcessor::Process(FFHostInputBlock const& input, FFRawStereoBlock& output, Processor& processor)
{
