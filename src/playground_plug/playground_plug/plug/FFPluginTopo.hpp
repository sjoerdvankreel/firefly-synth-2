...
template <class ProcessorMemory>
int*
FBRuntimeParam<ProcessorMemory>::EventPosAutoParamAddr(ProcessorMemory* memory) const
{
  return staticTopo.eventPosAutoParamAddr(moduleSlot, paramSlot, memory);
}
