...
FFCreateStaticTopology()
{
  ...
  oscillator.index = FFModuleOscillator;
  ...
  oscillatorGain.index = FFOscillatorParamGain;
  ...
  oscillatorPitch.index = FFOscillatorParamPitch;
  ...
  waveShaper.index = FFModuleWaveShaper;
  ...
  waveShaperOn.index = FFWaveShaperParamOn;
  ...
  waveShaperGain.index = FFWaveShaperParamGain;
