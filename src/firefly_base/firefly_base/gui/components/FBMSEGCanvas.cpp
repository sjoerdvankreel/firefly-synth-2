...
void
FBMSEGCanvas::mouseExit(MouseEvent const& event)
{
...
void
FBMSEGCanvas::mouseDown(MouseEvent const& event)
{
...
void
FBMSEGCanvas::mouseMove(MouseEvent const& e)
{
...
void
FBMSEGCanvas::mouseDoubleClick(MouseEvent const& event)
{
...
void
FBMSEGCanvas::mouseDrag(MouseEvent const& event)
{
