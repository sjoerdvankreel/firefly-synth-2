...
FFMakeOutputGUI(FBPlugGUI* plugGUI)
{
  ...
  grid->Add(0, 1, plugGUI->StoreComponent<FBOutputParamMeter>(plugGUI, gain));
  ...
  grid->Add(0, 3, plugGUI->StoreComponent<FBOutputParamMeter>(plugGUI, cpu));
  ...
  grid->Add(0, 5, plugGUI->StoreComponent<FBOutputParamMeter>(plugGUI, voices));
