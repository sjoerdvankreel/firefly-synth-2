...
FFMakeMasterTopo()
{
  ...
  auto& uniEchoExtend = result->params[(int)FFMasterParam::UniEchoExtend];
  uniEchoExtend.mode = FBParamMode::Block;
  uniEchoExtend.defaultText = "50";
  uniEchoExtend.name = "Uni Echo Extend";
  uniEchoExtend.display = "Echo Extend";
  uniEchoExtend.slotCount = FFMasterUniMaxCount;
  uniEchoExtend.unit = "%";
  uniEchoExtend.id = "{B60645F1-F349-4911-AA11-218E188C0D1F}";
  uniEchoExtend.type = FBParamType::Identity;
  auto selectUniEchoExtend = [](auto& module) { return &module.block.uniEchoExtend; };
  uniEchoExtend.scalarAddr = FFSelectScalarParamAddr(selectModule, selectUniEchoExtend);
  uniEchoExtend.globalBlockProcAddr = FFSelectProcParamAddr(selectModule, selectUniEchoExtend);
  uniEchoExtend.globalExchangeAddr = FFSelectExchangeParamAddr(selectModule, selectUniEchoExtend);
  uniEchoExtend.dependencies.enabled.audio.WhenSlots({ { (int)FFMasterParam::UniCount, -1 }, { (int)FFMasterParam::UniEchoExtend, -1 } }, [](auto const& slots, auto const& vs) { return slots[1] < vs[0] && vs[0] != 1; });

  auto& uniEchoFade = result->params[(int)FFMasterParam::UniEchoFade];
  uniEchoFade.mode = FBParamMode::Block;
  uniEchoFade.defaultText = "50";
  uniEchoFade.name = "Uni Echo Fade";
  uniEchoFade.display = "Echo Fade";
  uniEchoFade.slotCount = FFMasterUniMaxCount;
  uniEchoFade.unit = "%";
  uniEchoFade.id = "{A9F81A4A-1FB3-418B-86F5-8F49C77934B7}";
  uniEchoFade.type = FBParamType::Identity;
  auto selectUniEchoFade = [](auto& module) { return &module.block.uniEchoFade; };
  uniEchoFade.scalarAddr = FFSelectScalarParamAddr(selectModule, selectUniEchoFade);
  uniEchoFade.globalBlockProcAddr = FFSelectProcParamAddr(selectModule, selectUniEchoFade);
  uniEchoFade.globalExchangeAddr = FFSelectExchangeParamAddr(selectModule, selectUniEchoFade);
  uniEchoFade.dependencies.enabled.audio.WhenSlots({ { (int)FFMasterParam::UniCount, -1 }, { (int)FFMasterParam::UniEchoFade, -1 } }, [](auto const& slots, auto const& vs) { return slots[1] < vs[0] && vs[0] != 1; });
  ...
  auto& uniEchoReverbMix = result->params[(int)FFMasterParam::UniEchoReverbMix];
  uniEchoReverbMix.mode = FBParamMode::Accurate;
  uniEchoReverbMix.defaultText = "50";
  uniEchoReverbMix.name = "Uni Echo Rvrb Mix";
  uniEchoReverbMix.display = "Echo Rvrb Mix";
  uniEchoReverbMix.slotCount = FFMasterUniMaxCount;
  uniEchoReverbMix.unit = "%";
  uniEchoReverbMix.id = "{475A0982-1DEE-4636-B532-0D0FCD816DEC}";
  uniEchoReverbMix.type = FBParamType::Identity;
  auto selectUniEchoReverbMix = [](auto& module) { return &module.acc.uniEchoReverbMix; };
  uniEchoReverbMix.scalarAddr = FFSelectScalarParamAddr(selectModule, selectUniEchoReverbMix);
  uniEchoReverbMix.globalAccProcAddr = FFSelectProcParamAddr(selectModule, selectUniEchoReverbMix);
  uniEchoReverbMix.globalExchangeAddr = FFSelectExchangeParamAddr(selectModule, selectUniEchoReverbMix);
  uniEchoReverbMix.dependencies.enabled.audio.WhenSlots({ { (int)FFMasterParam::UniCount, -1 }, { (int)FFMasterParam::UniEchoReverbMix, -1 } }, [](auto const& slots, auto const& vs) { return slots[1] < vs[0] && vs[0] != 1; });

  auto& uniEchoReverbSize = result->params[(int)FFMasterParam::UniEchoReverbSize];
  uniEchoReverbSize.mode = FBParamMode::Accurate;
  uniEchoReverbSize.defaultText = "50";
  uniEchoReverbSize.name = "Uni Echo Rvrb Size";
  uniEchoReverbSize.display = "Echo Rvrb Size";
  uniEchoReverbSize.slotCount = FFMasterUniMaxCount;
  uniEchoReverbSize.unit = "%";
  uniEchoReverbSize.id = "{8E997A4E-BCF6-4599-9329-377E81F77B5F}";
  uniEchoReverbSize.type = FBParamType::Identity;
  auto selectUniEchoReverbSize = [](auto& module) { return &module.acc.uniEchoReverbSize; };
  uniEchoReverbSize.scalarAddr = FFSelectScalarParamAddr(selectModule, selectUniEchoReverbSize);
  uniEchoReverbSize.globalAccProcAddr = FFSelectProcParamAddr(selectModule, selectUniEchoReverbSize);
  uniEchoReverbSize.globalExchangeAddr = FFSelectExchangeParamAddr(selectModule, selectUniEchoReverbSize);
  uniEchoReverbSize.dependencies.enabled.audio.WhenSlots({ { (int)FFMasterParam::UniCount, -1 }, { (int)FFMasterParam::UniEchoReverbSize, -1 } }, [](auto const& slots, auto const& vs) { return slots[1] < vs[0] && vs[0] != 1; });

  auto& uniEchoReverbDamp = result->params[(int)FFMasterParam::UniEchoReverbDamp];
  uniEchoReverbDamp.mode = FBParamMode::Accurate;
  uniEchoReverbDamp.defaultText = "50";
  uniEchoReverbDamp.name = "Uni Echo Rvrb Damp";
  uniEchoReverbDamp.display = "Echo Rvrb Damp";
  uniEchoReverbDamp.slotCount = FFMasterUniMaxCount;
  uniEchoReverbDamp.unit = "%";
  uniEchoReverbDamp.id = "{6E27DACE-DEA9-4168-8752-6BFB0B09002E}";
  uniEchoReverbDamp.type = FBParamType::Identity;
  auto selectEchoUniReverbDamp = [](auto& module) { return &module.acc.uniEchoReverbDamp; };
  uniEchoReverbDamp.scalarAddr = FFSelectScalarParamAddr(selectModule, selectEchoUniReverbDamp);
  uniEchoReverbDamp.globalAccProcAddr = FFSelectProcParamAddr(selectModule, selectEchoUniReverbDamp);
  uniEchoReverbDamp.globalExchangeAddr = FFSelectExchangeParamAddr(selectModule, selectEchoUniReverbDamp);
  uniEchoReverbDamp.dependencies.enabled.audio.WhenSlots({ { (int)FFMasterParam::UniCount, -1 }, { (int)FFMasterParam::UniEchoReverbDamp, -1 } }, [](auto const& slots, auto const& vs) { return slots[1] < vs[0] && vs[0] != 1; });
