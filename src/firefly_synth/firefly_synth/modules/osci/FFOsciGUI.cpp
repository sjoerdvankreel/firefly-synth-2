...
{
  auto topo = plugGUI->HostContext()->Topo();
  std::vector<int> columnSizes = { 0, 0, 0, 1, 0, 0, 0, 0 };
  ...
  grid->Add(0, 0, plugGUI->StoreComponent<FBParamLabel>(plugGUI, mode, true, FBLabelColors::PrimaryBackground));
  ...
  grid->Add(0, 2, plugGUI->StoreComponent<FBParamLabel>(plugGUI, excite));
  grid->Add(0, 3, plugGUI->StoreComponent<FBParamSlider>(plugGUI, excite, Slider::SliderStyle::LinearHorizontal));
  ...
  grid->Add(1, 1, plugGUI->StoreComponent<FBParamSlider>(plugGUI, color, Slider::SliderStyle::RotaryVerticalDrag));
  ...
  grid->Add(1, 4, plugGUI->StoreComponent<FBParamLabel>(plugGUI, x));
  grid->Add(1, 5, plugGUI->StoreComponent<FBParamSlider>(plugGUI, x, Slider::SliderStyle::RotaryVerticalDrag));
  ...
  grid->Add(2, 1, 1, 5, plugGUI->StoreComponent<FBParamSlider>(plugGUI, damp, Slider::SliderStyle::LinearHorizontal));
  ...
  grid->Add(3, 1, 1, 5, plugGUI->StoreComponent<FBParamSlider>(plugGUI, feedback, Slider::SliderStyle::LinearHorizontal));
  ...
  grid->Add(4, 0, plugGUI->StoreComponent<FBParamLabel>(plugGUI, lpOn));
  grid->Add(4, 1, plugGUI->StoreComponent<FBParamToggleButton>(plugGUI, lpOn));
  auto lpFreq = topo->audio.ParamAtTopo({ { (int)FFModuleType::Osci, moduleSlot }, { (int)FFOsciParam::StringLPFreq, 0 } });
  grid->Add(4, 2, plugGUI->StoreComponent<FBParamLabel>(plugGUI, lpFreq));
  grid->Add(4, 3, plugGUI->StoreComponent<FBParamSlider>(plugGUI, lpFreq, Slider::SliderStyle::LinearHorizontal));
  auto lpRes = topo->audio.ParamAtTopo({ { (int)FFModuleType::Osci, moduleSlot }, { (int)FFOsciParam::StringLPRes, 0 } });
  grid->Add(4, 4, plugGUI->StoreComponent<FBParamLabel>(plugGUI, lpRes));
  grid->Add(4, 5, plugGUI->StoreComponent<FBParamSlider>(plugGUI, lpRes, Slider::SliderStyle::RotaryVerticalDrag));
  ...
  grid->Add(5, 0, plugGUI->StoreComponent<FBParamLabel>(plugGUI, hpOn));
  grid->Add(5, 1, plugGUI->StoreComponent<FBParamToggleButton>(plugGUI, hpOn));
  auto hpFreq = topo->audio.ParamAtTopo({ { (int)FFModuleType::Osci, moduleSlot }, { (int)FFOsciParam::StringHPFreq, 0 } });
  grid->Add(5, 2, plugGUI->StoreComponent<FBParamLabel>(plugGUI, hpFreq));
  grid->Add(5, 3, plugGUI->StoreComponent<FBParamSlider>(plugGUI, hpFreq, Slider::SliderStyle::LinearHorizontal));
  auto hpRes = topo->audio.ParamAtTopo({ { (int)FFModuleType::Osci, moduleSlot }, { (int)FFOsciParam::StringHPRes, 0 } });
  grid->Add(5, 4, plugGUI->StoreComponent<FBParamLabel>(plugGUI, hpRes));
  grid->Add(5, 5, plugGUI->StoreComponent<FBParamSlider>(plugGUI, hpRes, Slider::SliderStyle::RotaryVerticalDrag));
