...
FFMakeGUISettingsGUI(FBPlugGUI* plugGUI)
{
  ...
  grid->Add(2, 2, plugGUI->StoreComponent<FBGUIParamLabel>(plugGUI, knobVisualsMode));
  grid->Add(2, 3, plugGUI->StoreComponent<FBGUIParamComboBox>(plugGUI, knobVisualsMode));
  ...
  grid->Add(3, 2, plugGUI->StoreComponent<FBAutoSizeLabel>(plugGUI, "Theme"));
