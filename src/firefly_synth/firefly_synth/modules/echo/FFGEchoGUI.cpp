...
MakeGEchoSectionMain(FBPlugGUI* plugGUI, FBMultiContentComponent* tapsGUI)
{
  ...
  grid->Add(0, 4, plugGUI->StoreComponent<FBGUIParamLabel>(plugGUI, guiTapSelect));
  grid->Add(0, 5, tapSelectSlider);
  ...
  grid->Add(1, 4, 1, 2, plugGUI->StoreComponent<FBAutoSizeButton>("Edit Taps"));
