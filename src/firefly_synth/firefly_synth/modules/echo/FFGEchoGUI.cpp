...
MakeGEchoSectionTap(FBPlugGUI* plugGUI, int tap)
{
  ...
  grid->Add(1, 2, plugGUI->StoreComponent<FBParamLabel>(plugGUI, tapFeedback));
  grid->Add(1, 3, plugGUI->StoreComponent<FBParamSlider>(plugGUI, tapFeedback, Slider::SliderStyle::RotaryVerticalDrag));
