...
FFMakeEchoTopo(bool global)
{
  ...
  if (global)
    vTargetOrGTarget.List().items = {
      ...
      { "{9A195809-A9A8-454A-ACD1-5376892EE416}", "FX In" },
      { "{38A69D55-AB3E-49F2-9CCD-44917FD24597}", "FX Out" },
      { "{C510F9C1-13A6-4929-A7EA-7C5F79BA6E42}", "Mix Out" },
      { "{CDE64B50-C65D-43E9-B52E-325F544E5175}", "FX1 In" },
      { "{1C7AA2CC-2116-45E4-B7C2-AA9678CC15B5}", "FX1 Out" },
      { "{68C1469F-96FF-47D7-8A2E-B24309E10031}", "FX2 In" },
      { "{A043114B-C471-46A8-A526-B93E1897B1A0}", "FX2 Out" },
      { "{883FA130-AB68-42D5-B56A-C61039DAD9A6}", "FX3 In" },
      { "{56CE90EE-F9D0-4CCF-93B8-9BB0501DCBEF}", "FX3 Out" },
      { "{80ECC9AA-AC6B-44DC-B305-43057720A4AC}", "FX4 In" },
      { "{050E8D54-BFD2-4821-B14F-717D161D69DB}", "FX4 Out" } };
  else
    vTargetOrGTarget.List().items = {
