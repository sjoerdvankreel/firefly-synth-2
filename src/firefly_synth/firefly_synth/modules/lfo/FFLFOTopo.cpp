...
FFLFOWaveModeToString(int mode)
{
  ...
  case FFTrigSin2: return "Sin2";
  case FFTrigCos2: return "Cos2";
  case FFTrigSinCos: return "SnCs";
  case FFTrigCosSin: return "CsSn";
  case FFTrigSin3: return "Sin3";
  case FFTrigCos3: return "Cos3";
  case FFTrigSn2Cs: return "S2Cs";
  case FFTrigCs2Sn: return "C2Sn";
  case FFTrigSnCs2: return "SnC2";
  case FFTrigCsSn2: return "CsS2";
  case FFTrigSnCsSn: return "SCS";
  case FFTrigCsSnCs: return "CSC";
...
FFMakeLFOTopo(bool global)
{
  ...
  sync.dependencies.enabled.audio.WhenSimple({ (int)FFLFOParam::Type }, [](auto const& vs) { return vs[0] != 0; });
  ...
  seed.dependencies.enabled.audio.WhenSimple({ (int)FFLFOParam::Type }, [](auto const& vs) { return vs[0] != 0; });
  ...
  smoothTime.dependencies.visible.audio.WhenSimple({ (int)FFLFOParam::Sync }, [](auto const& vs) { return vs[0] == 0; });
  smoothTime.dependencies.enabled.audio.WhenSimple({ (int)FFLFOParam::Type, (int)FFLFOParam::Sync }, [](auto const& vs) { return vs[0] != 0 && vs[1] == 0; });
  ...
  smoothBars.dependencies.visible.audio.WhenSimple({ (int)FFLFOParam::Sync }, [](auto const& vs) { return vs[0] != 0; });
  smoothBars.dependencies.enabled.audio.WhenSimple({ (int)FFLFOParam::Type, (int)FFLFOParam::Sync }, [](auto const& vs) { return vs[0] != 0 && vs[1] != 0; });
  ...
  max.dependencies.enabled.audio.WhenSimple({ (int)FFLFOParam::Type, (int)FFLFOParam::OpType }, [](auto const& vs) { return vs[0] != 0 && vs[1] != 0; });
  ...
  waveMode.List().items = {
    ...
    { "{1A4E2DDB-2C58-4670-89BC-54AE6CD6EBC2}", FFLFOWaveModeToString(FFTrigCos) },
    { "{9CF1B435-0A87-4F41-BA5A-7A596ED6ABC3}", FFLFOWaveModeToString(FFTrigSin2) },
    { "{B1589DBB-756C-4EB2-B36C-758F45A42CBD}", FFLFOWaveModeToString(FFTrigCos2) },
    { "{1948DE4C-FDE5-471E-A4B1-2FCCA23AA877}", FFLFOWaveModeToString(FFTrigSinCos) },
    { "{FB7AAA67-5893-466C-9EF8-0D2E1ACC50D1}", FFLFOWaveModeToString(FFTrigCosSin) },
    { "{F2C4032D-EAE9-490F-A58C-BF7F467260F4}", FFLFOWaveModeToString(FFTrigSin3) },
    { "{8E871CFE-2311-45B7-9E96-AB531F0E7E30}", FFLFOWaveModeToString(FFTrigCos3) },
    { "{A679AA50-A2EC-4D2F-AB10-A1185745287A}", FFLFOWaveModeToString(FFTrigSn2Cs) },
    { "{90D388CD-38C8-4D7C-BAC5-0492274089DF}", FFLFOWaveModeToString(FFTrigCs2Sn) },
    { "{5237B3A9-A85F-4392-8A0C-340B1A6A3E1B}", FFLFOWaveModeToString(FFTrigSnCs2) },
    { "{7E804C32-169F-43C4-B87C-062FCB60DF26}", FFLFOWaveModeToString(FFTrigCsSn2) },
    { "{CBCB1AF6-4CA2-4381-A5B8-42A7D2F92A36}", FFLFOWaveModeToString(FFTrigSnCsSn) },
    { "{B6E84130-CC0D-4270-B901-C69E778DAFD8}", FFLFOWaveModeToString(FFTrigCsSnCs) },
    { "{0402BC62-9213-41D2-AFA3-885B3B0B046D}", FFLFOWaveModeToString(FFLFOWaveModeSaw) },
    { "{78CD93BD-B3EF-41BA-A36B-BB24791D31F6}", FFLFOWaveModeToString(FFLFOWaveModeTri) },
    { "{BE0EF052-FA6B-422A-BF2B-6B9BE3430F9D}", FFLFOWaveModeToString(FFLFOWaveModeSqr) },
    { "{BDDA97A8-05A0-4E50-A775-5BA66A9D25C8}", FFLFOWaveModeToString(FFLFOWaveModeUniRandom) },
    { "{5E5FF10F-A7C9-4552-B68F-0C8059661A8F}", FFLFOWaveModeToString(FFLFOWaveModeNormRandom) },
    { "{B6B47502-BA24-42A6-80D7-D41FE62F06DF}", FFLFOWaveModeToString(FFLFOWaveModeFreeUniRandom) },
    { "{C0E5ED50-832C-4375-BB9A-B868893583E8}", FFLFOWaveModeToString(FFLFOWaveModeFreeNormRandom) },
    { "{3D6C2670-3862-4E1D-9010-0D9A36DB5B26}", FFLFOWaveModeToString(FFLFOWaveModeUniSmooth) },
    { "{9F652B6C-EF0F-49E9-B1AA-124230F1632D}", FFLFOWaveModeToString(FFLFOWaveModeNormSmooth) },
    { "{B48C5047-3ABD-4D03-86C9-0B4700E6B035}", FFLFOWaveModeToString(FFLFOWaveModeFreeUniSmooth) },
    { "{C93F4537-7A79-4FE2-908A-A5811767E425}", FFLFOWaveModeToString(FFLFOWaveModeFreeNormSmooth) } };
  ...
  rateHz.dependencies.visible.audio.WhenSimple({ (int)FFLFOParam::Sync }, [](auto const& vs) { return vs[0] == 0; });
  rateHz.dependencies.enabled.audio.WhenSimple({ (int)FFLFOParam::Type, (int)FFLFOParam::Sync, (int)FFLFOParam::OpType }, [](auto const& vs) { return vs[0] != 0 && vs[1] == 0 && vs[2] != 0; });
  ...
  rateBars.dependencies.visible.audio.WhenSimple({ (int)FFLFOParam::Sync }, [](auto const& vs) { return vs[0] != 0; });
  rateBars.dependencies.enabled.audio.WhenSimple({ (int)FFLFOParam::Type, (int)FFLFOParam::Sync, (int)FFLFOParam::OpType }, [](auto const& vs) { return vs[0] != 0 && vs[1] != 0 && vs[2] != 0; });
  ...
  skewAXMode.dependencies.enabled.audio.WhenSlots({ { (int)FFLFOParam::Type, 0 }, { (int)FFLFOParam::OpType, 0 } }, [](auto const& vs) { return vs[0] != 0 && vs[1] != 0; });
  ...
  skewAXAmt.dependencies.enabled.audio.WhenSlots({ { (int)FFLFOParam::Type, 0 }, { (int)FFLFOParam::OpType, 0 }, { (int)FFLFOParam::SkewAXMode, 0 } }, [](auto const& vs) { return vs[0] != 0 && vs[1] != 0 && vs[2] != 0; });
  ...
  skewAYMode.dependencies.enabled.audio.WhenSlots({ { (int)FFLFOParam::Type, 0 }, { (int)FFLFOParam::OpType, 0 } }, [](auto const& vs) { return vs[0] != 0 && vs[1] != 0; });
