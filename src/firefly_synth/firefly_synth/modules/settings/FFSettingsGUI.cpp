...
MakeSettingsTab(FBPlugGUI* plugGUI)
{
  ...
  grid->Add(0, 2, plugGUI->StoreComponent<FBParamLabel>(plugGUI, tuning));
  grid->Add(0, 3, plugGUI->StoreComponent<FBParamToggleButton>(plugGUI, tuning));
  ...
  grid->Add(0, 4, plugGUI->StoreComponent<FBParamLabel>(plugGUI, tuneMasterPB));
  grid->Add(0, 5, plugGUI->StoreComponent<FBParamToggleButton>(plugGUI, tuneMasterPB));
