...
FFMakeGNoteTopo()
{
  ...
  outputLastKeyRaw.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.last.keyUntuned.raw; };
  ...
  outputLastKeySmth.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.last.keyUntuned.smooth; };
  ...
  outputLastVeloRaw.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.last.velo.raw; };
  ...
  outputLastVeloSmth.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.last.velo.smooth; };
  ...
  outputLowKeyKeyRaw.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.lowKey.keyUntuned.raw; };
  ...
  outputLowKeyKeySmth.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.lowKey.keyUntuned.smooth; };
  ...
  outputLowKeyVeloRaw.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.lowKey.velo.raw; };
  ...
  outputLowKeyVeloSmth.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.lowKey.velo.smooth; };
  ...
  outputHighKeyKeyRaw.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.highKey.keyUntuned.raw; };
  ...
  outputHighKeyKeySmth.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.highKey.keyUntuned.smooth; };
  ...
  outputHighKeyVeloRaw.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.highKey.velo.raw; };
  ...
  outputHighKeyVeloSmth.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.highKey.velo.smooth; };
  ...
  outputLowVeloKeyRaw.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.lowVelo.keyUntuned.raw; };
  ...
  outputLowVeloKeySmth.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.lowVelo.keyUntuned.smooth; };
  ...
  outputLowVeloVeloRaw.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.lowVelo.velo.raw; };
  ...
  outputLowVeloVeloSmth.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.lowVelo.velo.smooth; };
  ...
  outputHighVeloKeyRaw.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.highVelo.keyUntuned.raw; };
  ...
  outputHighVeloKeySmth.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.highVelo.keyUntuned.smooth; };
  ...
  outputHighVeloVeloRaw.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.highVelo.velo.raw; };
  ...
  outputHighVeloVeloSmth.globalAddr = [](int, int, void* state) { return &static_cast<FFProcState*>(state)->dsp.global.gNote.outputKeyMatrix.highVelo.velo.smooth; };
